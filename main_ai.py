from video_monitor_ai import VideoMonitorAI
...
class SmartCarAppAI:
    ...
    def create_video_window(self):
        ...
        video_root.title("视频监控 - AI版")
        return VideoMonitorAI(video_root, host=self.ip_entry.get(), port=5001)
